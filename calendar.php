            ...
            <tr>
              ...
              <td style="text-align: right">
                <span class="btn-group">
                  ...
                  <button class="js-cal-option btn btn-default {{: mode==='day'? 'active':'' }}" data-mode="day">Día</button>
                </span>
              </td>
            </tr>
          </table>
...
<div class="container">
  <hr><a href="main.html"><input type="button" value="Volver al Menú Principal" class="btn btn-primary"></a><hr>
</div>
